package com.laptopselling.laptop.config;

//import com.example.api.util.JwtRequestFilter;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.laptopselling.laptop.util.JwtRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable().authorizeRequests()
                .antMatchers(HttpMethod.OPTIONS,"/auth/*",  "/notification/**").permitAll()
//                .antMatchers(HttpMethod.POST,"/**").authenticated()
//                .antMatchers(HttpMethod.PUT,"/**").authenticated()
//                .antMatchers(HttpMethod.DELETE,"/**").authenticated()
//                .antMatchers(HttpMethod.GET,"/file/**").authenticated()
